...
const facilities = [
  { 
    ...
    type: "Indoor", 
    pricePerHour: 1000,
    description: "Our luxurious Grand Ballroom is perfect for large-scale events, weddings, and conferences. It features state-of-the-art audiovisual equipment and customizable lighting.",
    images: [
      {
      ...
      },
      {
        ...
        hotspots: [
          { x: 50, y: 50, title: "Dance Floor", description: "A large dance floor perfect for social events and celebrations" }
        ],
  ...
  { 
    ...
    type: "Outdoor", 
    pricePerHour: 750,
    description: "Our charming Garden Pavilion offers a beautiful outdoor setting for weddings, parties, and corporate events. It features lush landscaping and a covered area.",
    images: [
      {
        ...
        hotspots: [
          { x: 40, y: 60, title: "Pavilion", description: "Covered area for events, protecting guests from sun and light rain" },
          { x: 70, y: 30, title: "Garden Area", description: "Beautiful landscaped gardens perfect for photos and mingling" }
        ],
      ...
      },
      {
        ...
        hotspots: [
          { x: 50, y: 50, title: "Seating Area", description: "Flexible seating arrangements to suit various event types" }
        ],
  ...
  { 
    ...
    type: "Indoor", 
    pricePerHour: 500,
    description: "Our modern Conference Hall is ideal for business meetings, seminars, and workshops. It's equipped with the latest technology for presentations and video conferencing.",
    images: [
      {
        ...
        hotspots: [
          { x: 30, y: 50, title: "Presentation Screen", description: "Large screen for presentations and video conferencing" },
      ...
      },
      {
        ...
        hotspots: [
          { x: 50, y: 50, title: "Tech Hub", description: "Central control for all audiovisual equipment" }
        ],
  ...
  { 
    ...
    type: "Indoor", 
    pricePerHour: 1500,
    description: "Our state-of-the-art Sports Complex is perfect for various sporting events, tournaments, and fitness activities. It features multiple courts and a large spectator area.",
    images: [
      {
  ...
  { 
    ...
    type: "Outdoor", 
    pricePerHour: 800,
    description: "Our stunning Amphitheater provides a unique outdoor venue for concerts, performances, and ceremonies. It features tiered seating and a spacious stage area.",
    images: [
      {
  ...
  { 
    ...
    type: "Indoor", 
    pricePerHour: 2000,
    description: "Our spacious Exhibition Center is perfect for trade shows, conventions, and large-scale exhibitions. It features ample space for booths and displays.",
    images: [
      {
...
export default function FacilitiesPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12 px-4 sm:px-6 lg:px-8 rounded-lg shadow-xl">
        <h1 className="text-4xl font-extrabold mb-4">Explore Our Facilities</h1>
        <p className="text-xl mb-8">Find the perfect space for your next event</p>
        ...
        {filteredFacilities.map((facility) => (
          <Card key={facility.id} className="overflow-hidden transition-all duration-300 hover:shadow-lg">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 mb-2">Type: {facility.type}</p>
              <p className="text-gray-600 mb-2">Price: ₱{facility.pricePerHour}/hour</p>
      ...
      <div className="bg-gray-100 rounded-lg shadow-inner p-8 text-center">
        <h2 className="text-3xl font-bold mb-4">Can't find what you're looking for?</h2>
        <p className="text-xl text-gray-600 mb-6">We can help you find or create the perfect space for your event.</p>
        <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white">
          Request Custom Facility
        </Button>
      </div>
